...
CREATE TABLE tracks( path VARCHAR(255) NOT NULL PRIMARY KEY, 
    title VARCHAR(100) COLLATE NOCASE, 
    artist VARCHAR(50) COLLATE NOCASE, 
    album VARCHAR(50) COLLATE NOCASE, 
    genre VARCHAR(10) COLLATE NOCASE, 
    year VARCHAR(10), 
    track INT, 
    length INT, 
    bitrate INT, 
...
CREATE TABLE ipod_tracks( path VARCHAR(255) NOT NULL PRIMARY KEY,
    title VARCHAR(100) COLLATE NOCASE, 
    artist VARCHAR(50) COLLATE NOCASE, 
    album VARCHAR(50) COLLATE NOCASE, 
    genre VARCHAR(10) COLLATE NOCASE, 
...
CREATE TABLE albums( artist VARCHAR(50) NOT NULL COLLATE NOCASE, 
    album VARCHAR(50) NOT NULL COLLATE NOCASE, 
    image VARCHAR(40), 
...
CREATE TABLE radio_items( radio VARCHAR(20) NOT NULL COLLATE NOCASE,
    title VARCHAR(100), 
    description VARCHAR(100), 
    url VARCHAR(255) NOT NULL, 
    bitrate VARCHAR(10), 
    PRIMARY KEY(radio, url) );

CREATE TABLE directories( path VARCHAR(255) NOT NULL PRIMARY KEY, 
    modified INT NOT NULL );

CREATE TABLE podcasts( path VARCHAR(255) NOT NULL PRIMARY KEY,
    title TEXT, pub_date TEXT, 
    image TEXT, 
    description TEXT );

CREATE TABLE podcast_items( podcast_path VARCHAR(255) NOT NULL,
    path VARCHAR(255) NOT NULL, 
    title TEXT, 
    pub_date TEXT, 
    description TEXT, 
