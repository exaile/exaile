...
class LastFMLover(object):
    ...
    def __init__(self):
        ...
        self.loved_tracks = []
        self.timer = None
        self.column_menu_item = ColumnMenuItem(
            column=LoveColumn, after=['__rating'])
    ...
    def love_track(self, track):
        ...
        try:
            ...
            logger.warning(
                'Error while loving track {0}: {1}'.format(track, e))
        else:
    ...
    def unlove_track(self, track):
        ...
        try:
            ...
            logger.warning(
                'Error while unloving track {0}: {1}'.format(track, e))
        else:
