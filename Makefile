...
test:
	EXAILE_DIR=$(shell pwd) LC_ALL=C PYTHONPATH=$(shell pwd) python3 -m pytest --ignore=tests/xl/player --ignore=tests/xl/trax/test_search.py --ignore=tests/xl/trax/test_track.py --ignore=tests/xl/trax/test_util.py tests
