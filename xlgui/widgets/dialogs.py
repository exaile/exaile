...
def yesno(parent, message):
    ...
    dlg = Gtk.MessageDialog(parent=parent, type=Gtk.MessageType.QUESTION,
...
class MultiTextEntryDialog(Gtk.Dialog):
    ...
    def add_field(self, label):
        ...
        entry.connect(
            'activate', lambda *e: self.response(Gtk.ResponseType.OK))
...
class FileOperationDialog(Gtk.FileChooserDialog):
    ...
    def __init__(self, title=None, parent=None, action=Gtk.FileChooserAction.OPEN,
        ...
        Gtk.FileChooserDialog.__init__(
            self, title, parent, action, buttons, backend)
...
class PlaylistExportDialog(FileOperationDialog):
    ...
    def __init__(self, playlist, parent=None):
        ...
        self.relative_checkbox = Gtk.CheckButton(
            _('Use relative paths to tracks'))
...
class ConfirmCloseDialog(Gtk.MessageDialog):
    ...
    def __init__(self, document_name):
        ...
        self.set_markup(
            _('<b>Save changes to %s before closing?</b>') % document_name)
...
class FileCopyDialog(Gtk.Dialog):
    ...
    def _start_next_copy(self, overwrite=False):
        ...
        self.source.copy_async(
            self.destination, self._finish_single_copy, flags=flags, cancellable=self.cancel)
    ...
    def _on_error(self, message):
        ...
        dialog = Gtk.MessageDialog(
            self.parent, Gtk.DialogFlags.MODAL, Gtk.MessageType.ERROR, Gtk.ButtonsType.CLOSE)
