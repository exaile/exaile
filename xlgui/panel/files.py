...
class FilesPanel(panel.Panel):
    ...
    def __init__(self, controller, collection):
        ...
        self.first_dir = SETTINGSMANAGER.get_option('gui/files_panel_dir',
            xdg.homedir)
    ...
    def _setup_tree(self):
        ...
        width = SETTINGSMANAGER.get_option('gui/files_%s_col_width' %
            _('Filename'), 130)
...
#                        self.exaile.playlist_manager.append_songs((tr, ))
    ...
    def set_column_width(self, col, stuff=None):
        ...
        SETTINGSMANAGER.set_option(name, col.get_width())
    ...
    def load_directory(self, dir, history=True, keyword=None):
        ...
        SETTINGSMANAGER.set_option('gui/files_panel_dir', dir)
        self.current = dir
        directories = []
        files = []
        for path in paths:
