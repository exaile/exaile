...
class JamendoPanel(panel.Panel):
    ...
    ui_info = (os.path.dirname(__file__) +
               "/ui/jamendo_panel.ui", 'JamendoPanelWindow')
    ...
    def setup_widgets(self):
        ...
        # setup images
        window = Gtk.Window()
        self.artist_image = GdkPixbuf.Pixbuf.new_from_file(
            xdg.get_data_path('images', '16x16', 'artist.png'))
        self.album_image = window.render_icon(
        ...
        self.model = Gtk.TreeStore(
            GdkPixbuf.Pixbuf, str, GObject.TYPE_PYOBJECT)
    ...
    # add_to_playlist: Whether or not add_to_playlist() should be called when
    # done
    ...
    # artist: The jamtree.Artist object that should have had its albums
    # populated by the jamapi thread
    ...
    # album: The jamtree.Album object that should have had its tracks
    # populated by the jamapi thread
    ...
    def add_tracks_to_playlist(self, track_list):
        # convert list to list of xl.Track objects as opposed to jamtree.Track
        # objects
        xltrack_list = []
