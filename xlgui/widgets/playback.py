...
class SeekProgressBar(Gtk.EventBox, providers.ProviderHandler):
    ...
    def on_hierarchy_changed(self, widget, old_toplevel):
        ...
        prev_conn = getattr(
            self, '_SeekProgressBar__prev_focus_out_conn', None)
        if prev_conn:
...
class VolumeControl(Gtk.Box):
    ...
    def __init__(self, player):
        ...
        self.button.add_events(
            Gdk.EventMask.KEY_PRESS_MASK | Gdk.EventMask.SCROLL_MASK)
